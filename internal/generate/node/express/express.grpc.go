...
// NodeGRPC finds the primary .proto file for the Express/Node project and
// copies it to outputDir/schema.proto.
func NodeGRPC(projectDir, outputDir string) error {
	...
	return copyFile(src, filepath.Join(outputDir, "schema.proto"))
}
