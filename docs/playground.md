...
Try drift-bot interactively — no install required.

**[Open Playground →](https://drift-bot-theta.vercel.app/)**
...
This is the same scanner used by `drift-bot impact` — the playground lets you try it without a local install.
