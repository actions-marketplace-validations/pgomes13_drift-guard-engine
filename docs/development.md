...
```
cmd/drift-bot/          # CLI entry point (drift-bot binary)
cmd/server/               # gRPC server entry point
cmd/mcp-server/           # MCP server entry point (AI/LLM integration)
api/drift-bot/v1/       # Protobuf service definition & generated Go code
internal/
  parser/
